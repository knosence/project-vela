...
The single cornerstone is [Cornerstone.Knosence-SoT.md](/home/knosence/vela/knowledge/Cornerstone.Knosence-SoT.md). The top-level registry is [000a.INDEX.Knosence-Matrix-Ref.md](/home/knosence/vela/knowledge/ARTIFACTS/refs/000a.INDEX.Knosence-Matrix-Ref.md). The Trinity consists of the Cornerstone, the Key at [230.DOMAIN.SoT-Source-of-Truth-SoT.md](/home/knosence/vela/knowledge/230.DOMAIN.SoT-Source-of-Truth-SoT.md), and the System at [240.DOMAIN.Matrix-SoT.md](/home/knosence/vela/knowledge/240.DOMAIN.Matrix-SoT.md). Sovereign surfaces include the cornerstone, identity SoTs, the canonical watchlist SoT, and local matrix laws.
...
Canonical SoTs follow `{ID}.{Context}.{Subject}-SoT.md` for hubs and branch SoTs, with the cornerstone as the singular exception. Canonical refs now use parent-based letter-suffixed IDs such as `000a`, `280a`, and `290a`. Retired IDs may be reused only when the old file no longer exists.

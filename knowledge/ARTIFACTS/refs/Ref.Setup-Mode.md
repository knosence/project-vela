...
The system starts in setup mode until required values exist in `runtime/config/project-vela.yaml`. The starter worksheet in `knowledge/INBOX/000.Project-Vela-Starter.md` is the human-editable collection point for those values.

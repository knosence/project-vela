...
MATRIX_INDEX_PATH = REPO_ROOT / "knowledge" / "ARTIFACTS" / "refs" / "000a.INDEX.Knosence-Matrix-Ref.md"
MATRIX_INDEX_JSON_PATH = REPO_ROOT / "runtime" / "config" / "matrix-index.json"
DREAMER_ACTIONS_PATH = REPO_ROOT / "runtime" / "config" / "dreamer-actions.json"
OPERATIONS_STATE_PATH = REPO_ROOT / "runtime" / "config" / "operations-state.json"

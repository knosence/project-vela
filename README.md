...
Run `python3 -m prototypes.python.vela.cli init`, `python3 -m prototypes.python.vela.cli setup`, `python3 -m prototypes.python.vela.cli index`, `python3 -m prototypes.python.vela.cli dry-boot`, `python3 -m prototypes.python.vela.cli verify --scenario full`, and `python3 -m prototypes.python.vela.cli growth apply <proposal>` from the repository root.
